...
const SocialsBlock: React.FC = () => (
  <div className="flex flex-wrap justify-center gap-4 w-full font-inter z-10 relative">
...
const AboutBlock = () => (
  <div className="w-full rounded-2xl border border-zinc-800 bg-zinc-950/80 p-7 shadow-lg text-center font-inter z-10 relative">
...
const ConnectSection: React.FC = () => {
  ...
  return (
    <section className="w-full flex flex-col items-center text-center gap-4 mt-8 font-inter relative z-10">
      {/* Toast Notification */}
      {showToast && (
...
export const PersonalLanding = () => {
  return (
    <div 
      className="min-h-screen w-full flex flex-col items-center justify-start bg-gradient-to-br from-zinc-900 via-zinc-950 to-zinc-900 px-4 pb-16 text-zinc-50 font-inter relative overflow-hidden"
      style={{ paddingTop: '180px' }}
    >
    {/* Animated background blob */}
    <div 
      className="absolute w-[500px] h-[500px] bg-gradient-to-tr from-pink-500 via-red-500 to-orange-400 opacity-20 rounded-full blur-3xl animate-[pulse_4s_ease-in-out_infinite] z-0" 
