  ...
  return (
    <section className="w-full flex flex-col items-center text-center gap-6">
      <div className="relative mb-2">
        ...
        <div className="relative size-32 rounded-full border-4 border-zinc-800 shadow-xl z-10 bg-zinc-900 flex items-center justify-center p-4">
      ...
      <p className="text-xl md:text-2xl text-zinc-300 max-w-lg mx-auto font-inter font-normal">
        B.Tech in Computer Science and Engineering focused on Software, FullStack, MERN Stack, and web/Application development. Working as Freelancer worldwide with the clients accross the world (Worked for the clients from USA, UK, Australia, Canada, India (domestic) from 2023 to present.
      </p>
    </section>
  );
};
