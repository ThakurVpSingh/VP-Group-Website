...
const PrivacyPolicyPage = () => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = "Privacy Policy | VP Group & Technologies";
  }, []);
          ...
          <div className="glass-panel policy-content-panel">
            ...
            <div className="policy-text-body">
              ...
              <ul>
                ...
                <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to VP Group & Technologies, Saraiganai, Baba belkhar Nath Dham, Pratapgarh, Uttar Pradesh, 230403.</li>
                ...
                <li>
                  ...
                  <p style={{ marginTop: '8px', marginBottom: 0 }}>We use "Personal Data" and "Personal Information" interchangeably unless a law uses a specific term.</p>
                </li>
              ...
              <ul>
                <li>
                  ...
                  <p style={{ marginTop: '8px', marginBottom: '8px' }}>Type: Session Cookies</p>
                  <p style={{ marginBottom: '8px' }}>Administered by: Us</p>
                  <p style={{ marginBottom: 0 }}>Purpose: These Cookies are essential to provide You with services available through the Website and to enable You to use some of its features. They help to authenticate users and prevent fraudulent use of user accounts. Without these Cookies, the services that You have asked for cannot be provided, and We only use these Cookies to provide You with those services.</p>
                </li>
                <li>
                  <strong>Cookies Policy / Notice Acceptance Cookies</strong>
                  <p style={{ marginTop: '8px', marginBottom: '8px' }}>Type: Persistent Cookies</p>
                  <p style={{ marginBottom: '8px' }}>Administered by: Us</p>
                  <p style={{ marginBottom: 0 }}>Purpose: These Cookies identify if users have accepted the use of cookies on the Website.</p>
                </li>
                <li>
                  <strong>Functionality Cookies</strong>
                  <p style={{ marginTop: '8px', marginBottom: '8px' }}>Type: Persistent Cookies</p>
                  <p style={{ marginBottom: '8px' }}>Administered by: Us</p>
                  <p style={{ marginBottom: 0 }}>Purpose: These Cookies allow Us to remember choices You make when You use the Website, such as remembering your login details or language preference. The purpose of these Cookies is to provide You with a more personal experience and to avoid You having to re-enter your preferences every time You use the Website.</p>
                </li>
              </ul>
