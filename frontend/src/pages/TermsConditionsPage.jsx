...
const TermsConditionsPage = () => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = "Terms and Conditions | VP Group & Technologies";
  }, []);
  ...
  return (
    <div className="policy-page-container">
      ...
      <div className="policy-glow-bg"></div>
      ...
      <main className="policy-main">
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          ...
          <div className="glass-panel policy-content-panel">
            <div className="policy-header">
              <div className="policy-icon-badge">
                <FileText size={24} />
              </div>
              <h1 className="policy-main-title">Terms and Conditions</h1>
              <p className="policy-date">Last updated: June 04, 2026</p>
            </div>
            ...
            <div className="policy-text-body">
              ...
              <ul>
                ...
                <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in these Terms and Conditions) refers to VP Group & Technologies, Saraiganai, Baba belkhar Nath Dham, Pratapgarh, Uttar Pradesh, 230403.</li>
                <li><strong>Device</strong> means any device that can access the Service such as a computer, a cell phone or a digital tablet.</li>
                <li><strong>Service</strong> refers to the Website.</li>
                <li><strong>Terms and Conditions</strong> (also referred to as "Terms") means these Terms and Conditions, including any documents expressly incorporated by reference, which govern Your access to and use of the Service and form the entire agreement between You and the Company regarding the Service. These Terms and Conditions have been created with the help of the Terms and Conditions Generator.</li>
                ...
                <li><strong>Website</strong> refers to VP Group & Technologies, accessible from <a href="https://vp-group-website.vercel.app/" target="_blank" rel="noopener noreferrer">https://vp-group-website.vercel.app/</a>.</li>
              ...
              <ul>
                <li>By email: contact.vpsdev@gmail.com</li>
                <li>By visiting this page on our website: <a href="https://vp-group-website.vercel.app/" target="_blank" rel="noopener noreferrer">https://vp-group-website.vercel.app/</a></li>
              </ul>
            </div>
          </div>
      ...
      <style>{`
        ...
        .policy-glow-bg {
          ...
          width: 800px;
          height: 400px;
          background: radial-gradient(circle, rgba(255, 78, 240, 0.04) 0%, rgba(139, 92, 246, 0.02) 50%, transparent 80%);
          z-index: 0;
          pointer-events: none;
        }
        ...
        .policy-icon-badge {
          ...
          height: 60px;
          border-radius: 18px;
          background: rgba(255, 78, 240, 0.06);
        ...
        .policy-text-body li::before {
          ...
          border-radius: 50%;
          background: #ff4ef0;
          box-shadow: 0 0 10px #ff4ef0;
        }

        .policy-text-body li ul {
        ...
        .policy-text-body a:hover {
          color: #ff4ef0;
          border-bottom-color: #ff4ef0;
        }
